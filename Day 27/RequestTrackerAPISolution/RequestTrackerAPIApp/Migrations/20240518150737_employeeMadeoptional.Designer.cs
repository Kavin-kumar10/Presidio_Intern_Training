...
namespace RequestTrackerAPIApp.Migrations
{
    ...
    [Migration("20240518150737_employeeMadeoptional")]
    partial class employeeMadeoptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RequestTrackerAPIApp.Modals.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RequestTrackerAPIApp.Modals.Request", b =>
                {
            ...
            modelBuilder.Entity("RequestTrackerAPIApp.Modals.User", b =>
                {
            ...
            modelBuilder.Entity("RequestTrackerAPIApp.Modals.Request", b =>
                {
                    b.HasOne("RequestTrackerAPIApp.Modals.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("RequestTrackerAPIApp.Modals.Employee", "RaisedByEmployee")
            ...
            modelBuilder.Entity("RequestTrackerAPIApp.Modals.User", b =>
                {
                    b.HasOne("RequestTrackerAPIApp.Modals.Employee", "Employee")
                        .WithMany()
